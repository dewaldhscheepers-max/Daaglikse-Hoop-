/* ────────────────────────────────────────────────────────────
   ...
   Albei rigtings vra die admin-geheim. Die plafon self is nie 'n geheim nie,
   maar vandag se telling wys hoeveel mense geskryf het, en dit is niemand
   anders se saak nie.
