/* ────────────────────────────────────────────────────────────
   ...
   ken. Elkeen kry daarom drie dinge wat verskil:
     ...
     · 'n eie silhoeët  (rond, druppel, tros, druiwe, aar, punt)
     · 'n eie oppervlak (kolle, strepe, segmente, korrels, skoon)
     · 'n eie kroontjie (blaar, steel, blomkelk, niks)

   Die nege stem ooreen met die nege eienskappe, maar die spel preek dit nie
   tydens spel nie. Dit wys in die name van die hoofstukke en die wapens.
   ──────────────────────────────────────────────────────────── */
...
const V = [
  ...
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        ...
        <path d="M32 21v28M18 35h28M22 25l20 20M42 25L22 45" stroke={d} strokeWidth="2" strokeLinecap="round" />
        <circle cx="32" cy="35" r="4" fill={d} />
        <path d="M32 14v-4" stroke="#6B4A22" strokeWidth="3" strokeLinecap="round" />
  ...
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        ...
        <path d="M32 30V16" stroke="#6B4A22" strokeWidth="3" strokeLinecap="round" />
  ...
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        ...
        <path d="M24 40c4 5 12 5 16 0" stroke={l} strokeWidth="2.4" strokeLinecap="round" fill="none" />
        <path d="M27 47c3 3 7 3 10 0" stroke={l} strokeWidth="2" strokeLinecap="round" fill="none" />
  ...
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        ...
        <path d="M25 27c-2 4-2 9 0 13" stroke={l} strokeWidth="3" strokeLinecap="round" fill="none" />
        <path d="M32 20V9" stroke="#6B4A22" strokeWidth="3.2" strokeLinecap="round" />
  ...
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        <path d="M32 56V26" stroke={d} strokeWidth="3" strokeLinecap="round" />
        {[0, 1, 2, 3].map(i => (
          <g key={i}>
            <ellipse cx={32 - 8} cy={22 + i * 8} rx="7" ry="4.4" fill={k} transform={`rotate(-28 ${24} ${22 + i * 8})`} />
            <ellipse cx={32 + 8} cy={22 + i * 8} rx="7" ry="4.4" fill={d} transform={`rotate(28 ${40} ${22 + i * 8})`} />
          </g>
        ))}
        <ellipse cx="32" cy="14" rx="5" ry="8" fill={k} />
      </>
    ),
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        ...
        <path d="M32 15c-5 6-7 13-7 21s2 15 7 20" stroke={d} strokeWidth="2.6" fill="none" strokeLinecap="round" />
        <ellipse cx="24" cy="28" rx="6" ry="4.5" fill={l} transform="rotate(-30 24 28)" />
        <path d="M32 15V8" stroke="#6B4A22" strokeWidth="3" strokeLinecap="round" />
  ...
  },
  {
    ...
    vorm: (k, d, l) => (
      <>
        ...
        <path d="M32 18c5 6 8 13 8 19 0 7-3 12-8 12" stroke={d} strokeWidth="2.2" fill="none" strokeLinecap="round" />
        <path d="M26 30c-2 5-2 10 0 14" stroke={l} strokeWidth="2.6" fill="none" strokeLinecap="round" />
...
/** Een vrug. `dof` word gebruik vir 'n vrug wat nog nie oopgesluit is nie. */
export function Vrug({ soort, grootte = 44, dof = false }) {
  ...
  return (
    <svg width={grootte} height={grootte} viewBox="0 0 64 64" role="img" aria-label={v.naam}>
      {v.vorm(k, d, l)}
    </svg>
  )
}
